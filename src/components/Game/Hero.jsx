...
const HERO_INIT_X = 10;
const HERO_INIT_Y = 10;
...
const HERO_LEFT_LEG_DOWN_Y = 0;
const HERO_LEFT_LEG_UP_X = 0;
const HERO_LEFT_LEG_UP_Y = 0;
const HERO_RIGHT_LEG_WIDTH = 217;
const HERO_RIGHT_LEG_HEIGHT = 332;
const HERO_RIGHT_LEG_DOWN_X = 0;
const HERO_RIGHT_LEG_DOWN_Y = 0;
const HERO_RIGHT_LEG_UP_X = 0;
const HERO_RIGHT_LEG_UP_Y = 0;
