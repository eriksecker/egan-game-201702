...
const HERO_LEFT_LEG_UP_X = 13;
const HERO_LEFT_LEG_UP_Y = 118;
const HERO_RIGHT_LEG_WIDTH = 217;
const HERO_RIGHT_LEG_HEIGHT = 332;
const HERO_RIGHT_LEG_DOWN_X = 426;
const HERO_RIGHT_LEG_DOWN_Y = 214;
const HERO_RIGHT_LEG_UP_X = 411;
const HERO_RIGHT_LEG_UP_Y = 195;
const HERO_LEG_SPEED = 10;
const HERO_LEG_ANIMATE_INTERVAL_RATE = 200;
